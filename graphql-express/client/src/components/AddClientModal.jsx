                        ...
                        <div className="modal-body">
                            <div>
                                ...
                                <div className="mb-3">
                                    ...
                                    <input type="email" className="form-control" id='email' value={email} onChange={(evt) => setEmail(evt.target.value)} />
                                </div>
                                <div className="mb-3">
                                    <label className="form-label">Phone</label>
                                    <input type="text" className="form-control" id='phone' value={phone} onChange={(evt) => setPhone(evt.target.value)} />
                                </div>

                                <button onClick={onSubmit} type="submit" data-bs-dismiss='modal' className="btn btn-secondary">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
