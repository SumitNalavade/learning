                                ...
                                <div className="modal-body">
                                    <div>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <select className="form-select" id="ClientId" value={clientId} onChange={(evt) => setClientId(evt.target.value)}>
                                        ...
                                        <button onClick={onSubmit} type="submit" data-bs-dismiss='modal' className="btn btn-primary">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
